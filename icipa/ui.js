...
function offerFileForDownload(file) {
    ...
    downloadAreaDiv === null || downloadAreaDiv === void 0 ? void 0 : downloadAreaDiv.prepend(p);
    downloadAreaDiv === null || downloadAreaDiv === void 0 ? void 0 : downloadAreaDiv.removeAttribute("style");
}
